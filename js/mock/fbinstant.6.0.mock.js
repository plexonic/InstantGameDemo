...
var FBInstant = {
    ...
    getEntryPointData: function () {
        ...
        Utils.log('getEntryPointData', 'query string: ', queryString, 'entry point data: ', queryString.entryPointData);
        if (queryString.entryPointData) {
            return JSON.parse(queryString.entryPointData[0]);
        }
        else {
            Utils.log('While using the mock SDK, set your entryPointData in the URL querystring', 'example: http://localhost:8080/?entryPointData={a:1,b:2,c:3}');
        }
    },
...
//# sourceMappingURL=fbinstant.6.0.mock.js.map